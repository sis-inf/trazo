...
> ⚠️ **Nota:** El subcomando `bench` **aún no está implementado** en el CLI. Esta documentación describe la funcionalidad planeada pero no disponible actualmente. Ver issue [#908](https://github.com/sis-inf/trazo/issues/908).
