# EJEMPLOS DE USO 
Este documento reúne ejemplos rápidos para comenzar a utilizar los métodos numéricos implementados, seguidos de ejemplos detallados con problemas planteados y soluciones paso a paso.
