...
Para saber de que *tipo* debes realizar el commit revisa el apartado de [convención de commits](#convenci%C3%B3n-de-commits).
...
[#idioma-del-proyecto](#idioma-del-proyecto)

**El español es el idioma oficial del proyecto.** Tras la consolidación de directorios (de inglés a español), todo el contenido nuevo o modificado debe escribirse en español, salvo las palabras reservadas propias del lenguaje de programación.

Esto aplica a:

- **Nombres de archivos**: deben estar en español.
- **Nombres de funciones y métodos**: deben estar en español.
- **Nombres de variables**: en español, usando camelCase.
- **Documentación** (README, CONTRIBUTING, comentarios de código, docs): en español.
- **Mensajes de error**: en español, para que sean entendibles por cualquier persona del equipo.

### Ejemplos correctos ✅

- Archivo: `calculadora_interes.py`
- Función: `calcularInteresCompuesto()`
- Variable: `tasaDeInteres`
- Mensaje de error: `"Error: el valor ingresado no puede ser negativo"`
- Comentario: `// Valida que el monto sea mayor a cero antes de procesar`

### Ejemplos incorrectos ❌

- Archivo: `interest_calculator.py`
- Función: `calculateCompoundInterest()`
- Variable: `interestRate`
- Mensaje de error: `"Error: the entered value cannot be negative"`
- Comentario: `// Validates that the amount is greater than zero before processing`

> ✅ Si tienes dudas sobre cómo traducir un término técnico, prioriza la claridad para el equipo por
> sobre una traducción literal. Las palabras reservadas del lenguaje (`if`, `for`, `class`, `return`, etc.) se mantienen como están, ya que son parte de la sintaxis y no del código que escribimos.
